...
const testimonials = [
  {
    name: "Marcus Johnson",
    role: "Parent",
    text: "My son's confidence and skills have skyrocketed since joining Nest Kings. The coaches truly care about each player's development.",
  },
  {
    name: "Sarah Williams",
    role: "Player, Age 16",
    text: "The group training sessions are intense but so much fun. I've improved my game more in 3 months here than 2 years elsewhere.",
  },
  {
    name: "David Chen",
    role: "Parent",
    text: "Professional, organized, and genuinely passionate about basketball. Best academy in the city, hands down.",
  },
  {
    name: "Emily Rodriguez",
    role: "Player, Age 14",
    text: "I love the team atmosphere. The coaches push you to be your best while making every session enjoyable.",
  },
];
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto text-center px-4 pt-20">
        ...
        <p className="text-muted-foreground text-lg md:text-xl mt-6 max-w-2xl mx-auto animate-fade-up-delay-2">
          Join the premier basketball training program. Build skills,
          confidence, and championship mentality.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <ScrollReveal delay={150}>
            ...
            <h2 className="font-heading text-3xl md:text-5xl font-bold uppercase mt-2 text-foreground">
              More Than Just a{" "}
              <span className="text-gradient">Basketball Academy</span>
            </h2>
            <p className="text-muted-foreground mt-6 leading-relaxed">
              Nest Kings was founded with a mission to develop well-rounded
              athletes and individuals. Our experienced coaching staff brings
              decades of professional and collegiate basketball experience to
              every training session.
            </p>
            <p className="text-muted-foreground mt-4 leading-relaxed">
              We believe in building character, discipline, and teamwork
              alongside basketball fundamentals.
            </p>
            <Link
              to="/about"
      ...
      <div className="container mx-auto">
          ...
          {[
            {
              icon: Users,
              title: "Team Building",
              desc: "Train alongside peers, develop chemistry, and learn the value of teamwork in competitive basketball.",
            },
            {
              icon: Trophy,
              title: "Skill Development",
              desc: "Master ball handling, shooting form, defensive techniques, and game IQ through structured programs.",
            },
            {
              icon: Star,
              title: "Physical Fitness",
              desc: "Improve strength, agility, endurance, and overall athleticism with basketball-specific conditioning.",
            },
          ].map((item, i) => (
        ...
        <div className="text-center mt-10">
          <ScrollReveal>
            <Link
              to="/services"
              className="bg-primary text-primary-foreground px-8 py-3 rounded-lg font-semibold uppercase tracking-wider text-sm hover:bg-primary/90 transition-all inline-flex items-center gap-2 hover:scale-105"
            >
      ...
      <div className="relative z-10 container mx-auto text-center px-4">
        <ScrollReveal>
          ...
          <p className="text-muted-foreground text-lg mt-4 max-w-xl mx-auto">
            Join Nest Kings today and take the first step towards becoming the
            player you were meant to be.
          </p>
          <a
            href="https://nestking.classcard.app/en/bookings"
            target="_blank"
