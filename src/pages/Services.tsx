...
const benefits = [
  {
    icon: Users,
    title: "Teamwork",
    desc: "Learn to play as a unit, communicate effectively, and build chemistry with teammates.",
  },
  {
    icon: Zap,
    title: "Skill Enhancement",
    desc: "Improve shooting, dribbling, passing, defense, and overall basketball IQ.",
  },
  {
    icon: Heart,
    title: "Physical Fitness",
    desc: "Build endurance, strength, agility, and cardiovascular health through basketball-specific training.",
  },
  {
    icon: Brain,
    title: "Mental Toughness",
    desc: "Develop resilience, focus, and the competitive mindset needed to succeed.",
  },
];
  ...
  <main className="pt-20">
    ...
    <section className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto text-center px-4">
        ...
        <p className="text-muted-foreground text-lg mt-4 max-w-2xl mx-auto animate-fade-up-delay-2">
          Our premier group training program combines competitive gameplay with
          expert coaching to develop complete basketball players.
        </p>
      </div>
    </section>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <ScrollReveal>
            ...
            <p className="text-muted-foreground mt-6 leading-relaxed">
              Our Training sessions are the heart of Nest Kings. Each session is
              carefully designed to challenge players at every level while
              fostering a supportive team environment.
            </p>
            <p className="text-muted-foreground mt-4 leading-relaxed">
              From fundamental drills to live scrimmages, our experienced
              coaches ensure that every minute on the court is productive,
              competitive, and fun.
            </p>
    ...
    <section className="section-padding">
      <div className="container mx-auto">
        <ScrollReveal>
          <SectionHeading
            subtitle="Rookie Start Program"
            title="Age Groups & Training Times"
          ...
          {ageGroups.map((g, i) => (
            <ScrollReveal key={i} delay={i * 100}>
              <div className="bg-card border border-border rounded-xl p-8 text-center hover:border-primary/50 transition-all duration-300 hover:-translate-y-1">
                ...
                <h3 className="font-heading text-xl font-semibold uppercase mt-2 text-foreground">
                  {g.name}
                </h3>
    ...
    <section className="section-padding bg-secondary text-center">
      <ScrollReveal>
        ...
        <p className="text-muted-foreground mt-4 max-w-lg mx-auto">
          Spots are limited. Reserve your place in the next training session
          today.
        </p>
        <a
