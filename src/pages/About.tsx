...
const whyChooseUs = [
  {
    ...
    desc: "Experienced coaches with professional and collegiate backgrounds.",
  },
  {
    icon: Users,
    title: "Small Groups",
    desc: "Personalized attention with optimized player-to-coach ratios.",
  },
  {
    icon: Shield,
    title: "Safe Environment",
    desc: "State-of-the-art facilities with a focus on player safety.",
  },
  {
    icon: Heart,
    title: "Character Building",
    desc: "We develop leaders, not just athletes, on and off the court.",
  },
];
        ...
        <ScrollReveal>
          <div className="text-center">
            ...
            <p className="text-muted-foreground leading-relaxed text-lg">
              Established in 2025, Nest Kings has quickly become one of the
              fastest growing basketball clubs in Melbourne Northern Suburbs. We
              are proud to have a roster of 70+ players.
            </p>
            <p className="text-muted-foreground leading-relaxed text-lg mt-4">
              Nest Kings has participated in multiple tournaments including the
              Sikh Games 2026, where we emerged as the Winner of the U11
              division. Training sessions have been running regularly for U10,
              U12, U16, and U18 since the club formed. We also proudly organised
              one of the biggest tournaments at Craigieburn Sports Stadium this
              year, with 8 clubs, 29 teams, and 300+ players participating.
            </p>
          </div>
        </ScrollReveal>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <ScrollReveal>
            <div className="bg-card border border-border rounded-xl p-10">
              ...
              <p className="text-muted-foreground mt-4 leading-relaxed">
                To provide world-class basketball training that develops
                skilled, confident, and disciplined athletes while fostering a
                love for the game and building strong character.
              </p>
            </div>
          </ScrollReveal>
          <ScrollReveal delay={150}>
            <div className="bg-card border border-border rounded-xl p-10">
              ...
              <p className="text-muted-foreground mt-4 leading-relaxed">
                To be the most trusted and impactful basketball academy,
                recognized for producing exceptional players and outstanding
                individuals who lead both on and off the court.
              </p>
            </div>
          </ScrollReveal>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <ScrollReveal delay={150}>
            ...
            <p className="text-muted-foreground mt-6 leading-relaxed">
              Coach Nippy has 13+ years of professional basketball career &
              years of coaching & training experience with multiple basketball
              clubs in Melbourne.
            </p>
            <p className="text-muted-foreground mt-4 leading-relaxed">
    ...
    <section className="section-padding text-center">
      <ScrollReveal>
        ...
        <p className="text-muted-foreground mt-4 max-w-lg mx-auto">
          Become part of the Nest Kings family and start your basketball journey
          today.
        </p>
        <a
